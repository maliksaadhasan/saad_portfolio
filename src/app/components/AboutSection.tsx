      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
          <motion.div
            ...
            className="p-6 sm:p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl"
          >
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 text-purple-400">What I Do</h3>
          ...
          <motion.div
            ...
            className="p-6 sm:p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl"
          >
            <h3 className="text-xl sm:text-2xl font-semibold mb-4 text-pink-400">How I Work</h3>
            <p className="text-white/70 leading-relaxed text-sm sm:text-base">
        ...
        >
          {stats.map((stat, index) => (
            <div
              key={index}
              className="p-6 sm:p-8 bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-xl border border-white/10 rounded-2xl text-center group hover:scale-105 transition-transform duration-300"
            >
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent flex items-center justify-center">
                {stat.prefix}
