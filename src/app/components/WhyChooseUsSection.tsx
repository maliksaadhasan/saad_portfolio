        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {reasons.map((reason, index) => {
            ...
            return (
              ...
              >
                <div className="relative p-6 sm:p-8 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl border border-white/10 rounded-2xl hover:border-white/20 transition-all duration-300 h-full">
                  <div className="relative mb-6">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold mb-3 text-white">{reason.title}</h3>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4 max-w-md sm:max-w-none mx-auto">
            <a
              ...
              className="w-full sm:w-auto px-6 py-4 sm:px-8 sm:py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-white font-medium hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 text-sm sm:text-base text-center"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto px-6 py-4 sm:px-8 sm:py-4 bg-white/5 backdrop-blur-xl border border-green-500/40 rounded-full text-white hover:bg-green-500/10 transition-all duration-300 text-sm sm:text-base text-center"
            >
              WhatsApp Me
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full sm:w-auto px-6 py-4 sm:px-8 sm:py-4 bg-white/5 backdrop-blur-xl border border-white/30 rounded-full text-white hover:bg-white/10 transition-all duration-300 text-sm sm:text-base text-center"
            >
              Connect on LinkedIn
            </a>
          </div>
